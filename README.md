...
Esse Sistema implementará funcionalidades que permitem comparações entre diferentes produtos, como quantidade em estoque e valor total, utilizando operadores relacionais sem estruturas de controle.
